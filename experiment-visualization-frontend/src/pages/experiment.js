...
import {Steps as AntdSteps, Progress, Card, Result} from 'antd';
...
export function ExperimentUI ({experimentData, dispatch} ) {
    ...
    const experimentStatus = prepareExperimentData(experimentData).status;
    ...
    if (experimentStatus === "init"){
        return <Result
            title="Initializing ..."
            subTitle={"Experiment is initializing ..."}
        />
    }else{
